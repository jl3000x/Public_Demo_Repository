...
public class ProductController {
    ...
    @GetMapping("/center")
    public String listProduct(@RequestParam(defaultValue = "", value = "searchName") String theSearchName,
                                Model theModel){
    ...
    // controller from the search box, which search name shall be empty and sort index is default.
    @GetMapping("/search")
    ...
    // controller from the search box, which search name and sort index can both be empty.
    @GetMapping("/show")
    ...
    @GetMapping("/page")
    public String showPage(@RequestParam("productId") int theId, Model theModel){
        
        // get the product from the service
        Product theProduct = theProductService.getProduct(theId);
