...
public class ProductControllerUnitTest {
    ...
    void listProductTest() throws Exception {
        ...
        System.out.println("\nStart test item: " + getClass().getName() + ".listProductTest()\n");
        ...
        System.out.println("\nFinish test item: " + getClass().getName() + ".listProductTest()\n");
    }
    ...
    void searchProductsTest() throws Exception {
        ...
        System.out.println("\nStart test item: " + getClass().getName() + ".searchProductsTest()\n");
        ...
        System.out.println("\nFinish test item: " + getClass().getName() + ".searchProductsTest()\n");
    }
    ...
    void searchAndSortProductsTest() throws Exception {
        ...
        System.out.println("\nStart test item: " + getClass().getName() + ".searchAndSortProductsTest()\n");
        ...
        System.out.println("\nFinish test item: " + getClass().getName() + ".searchAndSortProductsTest()\n");
    }
    ...
    void showProductPageTest() throws Exception {
        ...
        System.out.println("\nStart test item: " + getClass().getName() + ".showProductPageTest()\n");
        ...
        System.out.println("\nFinish test item: " + getClass().getName() + ".showProductPageTest()\n");
    }
}
